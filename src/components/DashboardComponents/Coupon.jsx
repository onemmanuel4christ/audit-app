        ...
        <Wrapper>
                ...
                <Form>
                    ...
                    <InnputContainer>
                            ...
                            <Input type="text" placeholder='vehicle ID' name='vehicleid'/>
                            </InputArea>
                            <InputArea>
                                <Label>Name of the filling station</Label>
                            <SelectBox>
                                <OptionBox>NNPC</OptionBox>
                                <OptionBox>Mobil</OptionBox>
                            </SelectBox>
                   ...
                   <InnputContainer>
                        <InputArea>
                            ...
                            <Input type="text" placeholder='driver’s ID' name='filstationlocation'/>
                   ...
                   <InnputContainer>
                        <InputArea>
                            ...
                            <Input type="text" placeholder='liters of fuel' name='litres'/>

                            </InputArea>

                            <InputArea>
                                <Label>Total Amount of Fuel</Label>
                                <Input type="number" placeholder='total amount' name='totalamount'/>
