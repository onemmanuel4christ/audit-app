    ...
    return(
        <Wrapper>
                ...
                <Form>
                    ...
                    <InnputContainer>
                            <InputArea>
                            <Label>Enter Name Of filling station</Label>
                            <Input type="text" placeholder='filling station name' name='filstationname'/>
                            </InputArea>
                            <InputArea>
                   ...
                   <InnputContainer>
                        <InputArea>
                            ...
                            <Input type="text" placeholder='Licence Number' name='filstationlocation'/>
